...
exports.extractTextFromImage = exports.sendMessage = void 0;
...
const openai = new openai_1.default({
    apiKey: (_a = config.openai) === null || _a === void 0 ? void 0 : _a.key,
});
...
exports.sendMessage = functions.https.onCall(async (data, context) => {
    ...
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'User must be authenticated to use this service.');
    }
    ...
    if (!messages || !Array.isArray(messages) || messages.length === 0) {
        throw new functions.https.HttpsError('invalid-argument', 'Messages array is required and cannot be empty.');
    }
    try {
        // Call OpenAI API
        ...
        if ((error === null || error === void 0 ? void 0 : error.status) === 429) {
            throw new functions.https.HttpsError('resource-exhausted', 'Too many requests. Please try again in a moment.');
        }
        throw new functions.https.HttpsError('internal', 'Failed to get response from AI. Please try again.');
    }
});
/**
...
exports.extractTextFromImage = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        throw new functions.https.HttpsError('internal', 'Failed to extract text from image. Please try again.');
    }
});
