      ...
      subtopics: [
        {
          ...
          examples: [
            ...
            'Evaluate 5y - 7 when y = 3',
            'Simplify: 6x + 2 - 4x + 9',
            'Combine like terms: 3m + 2n - m + 5n',
            'Write an expression for "3 less than 4 times a number"',
          ],
        },
      ],
    },
      ...
      subtopics: [
        {
          ...
          examples: [
            ...
            'What is the rule: 5, 10, 20, 40, ...',
            'Extend the pattern: 100, 90, 80, 70, ...',
            'Find the 10th term if the first is 3 and each increases by 4',
          ],
        },
        {
          id: 'sub-input-output',
          ...
          examples: [
            ...
            'Complete: x → 2x + 1. If x = 4, then output = ?',
            'Find the function rule: input 1,2,3,4 gives output 5,7,9,11',
            'Graph the function y = x + 4 for x from 0 to 5',
          ],
        },
        {
          ...
          examples: [
            ...
            'Write the equation: slope 3, y-intercept -2',
            'Graph y = -x + 5',
      ...
      subtopics: [
        {
          ...
          examples: [
            ...
            'If two angles are complementary, one is 28°. Find the other.',
            'Find the supplement of a 45° angle',
            'Two angles form a linear pair. One is 130°. Find the other.',
      ...
      subtopics: [
        {
          ...
          examples: [
            ...
            'Two angles of a triangle are 45° and 55°. Find the third.',
            'A triangle has sides 6, 8, 10. Is it a right triangle?',
            'Find the perimeter of an equilateral triangle with side 7',
            'In an isosceles triangle, two angles are 70° each. Find the third.',
          ],
        },
        {
          ...
          examples: [
            ...
            'Find the perimeter of a square with side 12',
            'A parallelogram has one angle of 110°. Find the other angles.',
            'Find the area of a rectangle: length 10, width 6',
      ...
      subtopics: [
        {
          ...
          examples: [
            ...
            'Find the area of a triangle: base 10, height 7',
            'A circle has radius 5. Find its area',
            'Find the area of a parallelogram: base 12, height 5',
          ],
        },
        {
          id: 'sub-volume',
          ...
          examples: [
            ...
            'Find volume of a box: length 8, width 3, height 4',
            'Find volume of cylinder: radius 2, height 15',
            'Find volume of cube with side 7',
            'A prism has base area 20 cm² and height 6 cm. Find volume.',
          ],
        },
        {
          id: 'sub-pythagorean',
          ...
          examples: [
            ...
            'Find leg a: b = 12, c = 13',
            'Is a triangle with sides 5, 12, 13 a right triangle?',
            'Find the missing leg: one leg = 9, hypotenuse = 15',
          ],
        },
      ],
    },
      ...
      subtopics: [
        {
          ...
          examples: [
            ...
            'Find the mode of: 5, 7, 7, 8, 9, 7, 10',
            'Find the mean of: 12, 18, 22, 15, 20',
          ],
        },
        {
          ...
          examples: [
            ...
            'Find the range of: 8, 15, 23, 12, 19',
            'Identify outliers in: 10, 12, 11, 13, 50, 12',
            'The data is 5, 8, 12, 15, 20. Find the range.',
            'Remove the outlier from: 3, 5, 7, 6, 30, 8. What is the new mean?',
          ],
        },
        {
          id: 'sub-data-viz',
          ...
          examples: [
            ...
            'Make a histogram for: ages 5-10, 10-15, 15-20',
            'Read the bar graph: Which month had the most rainfall?',
            'Create a line graph showing plant growth over 6 weeks',
            'In a circle graph, if sports is 90°, what percentage is that?',
          ],
        },
      ],
    },
      ...
      subtopics: [
        {
          ...
          examples: [
            ...
            'A bag has 5 green, 3 yellow, and 2 red balls. P(yellow) = ?',
            'What is the probability of picking a vowel from the word MATH?',
            'If you spin a spinner with 8 equal sections, what is P(landing on section 3)?',
          ],
        },
        {
          id: 'sub-sample-space',
          ...
          examples: [
            ...
            'List all outcomes for rolling 2 dice',
            'What is P(both heads) when flipping 2 coins?',
            'Create a tree diagram: pick a shirt (red, blue) then pants (jeans, shorts)',
            'What is P(sum of 10) when rolling two dice?',
          ],
        },
      ],
    },
      ...
      subtopics: [
        {
          ...
          examples: [
            ...
            'Solve the proportion: 2/7 = x/35',
            'If 4 pencils cost $2, how much do 10 pencils cost?',
            'Express ratio 24:36 in simplest form',
            'Solve: 5/8 = 15/x',
          ],
        },
        {
          ...
          examples: [
            ...
            'What is 15% of 200?',
            'A $60 item is on sale for 30% off. What is the sale price?',
            'If a value decreases from 80 to 60, what is the percent decrease?',
            'Find 40% of 150',
          ],
        },
        {
          ...
          examples: [
            ...
            'Which is cheaper: $10 for 2 pounds or $15 for 4 pounds?',
            'If speed is 55 mph, how far in 3 hours?',
            'At 50 mph, how long to travel 200 miles?',
          ],
        },
      ],
    },
      ...
      subtopics: [
        {
          ...
          examples: [
            ...
            'A store marks up 50% then gives 20% off. Final price of $80 item?',
            'Two cars start 300 miles apart, driving toward each other at 40 mph and 50 mph. When do they meet?',
            'Sarah has $400. She saves 25%, then spends 40% of savings. How much spent?',
            'A $100 item is marked up 60%, then discounted 30%. What is the final price?',
          ],
        },
      ],
    },
